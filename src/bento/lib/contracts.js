...
import BentoChefAbi from './abi/bentochef.json'
import XBentoAbi from './abi/xbento.json'
import BentoAbi from './abi/bento.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.bentoChef = new this.web3.eth.Contract(BentoChefAbi)
    this.xBentoStaking = new this.web3.eth.Contract(XBentoAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.bentoChef, contractAddresses.bentoChef[networkId])
    setProvider(this.xBentoStaking, contractAddresses.xBento[networkId])
  ...
  setDefaultAccount(account) {
    ...
    this.bentoChef.options.from = account
  }
