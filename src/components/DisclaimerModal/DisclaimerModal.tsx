...
const DisclaimerModal: React.FC<DisclaimerModal> = ({
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Omakase Bar will be the home of our new frontend, and provides
              an interface for all interactions with the BentoSwap protocol.
          </p>
          <p> Development will be on going, and bentoswapclassic will still
      ...
      return (
        <div>
          <StyledLink target="_blank" href="https://bentoswap.fi">
