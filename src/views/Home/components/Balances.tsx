...
import Img_Bento from '../../../assets/img/bento1.png'
    ...
    <StyledWrapper>
      <Card>
        <CardContent>
          <StyledBalances>
            <StyledBalance>
              <img src={Img_Bento} alt="" style={{width: '60px', height: '60px'}}/>
              <Spacer />
              <div style={{ flex: 1 }}>
                <Label text="Your BENTO Balance" color='#e86f55'/>
                <Value
                  value={!!account ? getBalanceNumber(bentoBalance) : 'Locked'}
                />
              </div>
            </StyledBalance>
          </StyledBalances>
      ...
      <Card>
        <CardContent>
          <Label text="Total BENTO Supply" color='#e86f55'/>
          <Value
        ...
        <Footnote>
          ...
          <FootnoteValue>1000 BENTO</FootnoteValue>
        </Footnote>
      </Card>
    </StyledWrapper>
  )
